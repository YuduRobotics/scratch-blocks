...
Blockly.DataCategory = function (workspace) {
  ...
  if (variableModelList.length > 0) {
    ...
    Blockly.DataCategory.addInitList(xmlList, firstVariable);
...
/**
 * Construct and add a data_initlist block to xmlList.
 * @param {!Array.<!Element>} xmlList Array of XML block elements.
 * @param {?Blockly.VariableModel} variable List variable to select.
 */
Blockly.DataCategory.addInitList = function (xmlList, variable) {
  // <block type="data_initlist">
  //   <field name="LIST" variabletype="list" id="">listname</field>
  //   <value name="LENGTH">
